...
public class RepositorySortExtensionsTests
{
    ...
    [
        new() { Name = "alpha", SupportedArchitectures = ["x86_64"], CreatedAt = Middle, UpdatedAt = Newest },
        new() { Name = "bravo", SupportedArchitectures = ["x86_64"], CreatedAt = Newest, UpdatedAt = Oldest },
        new() { Name = "charlie", SupportedArchitectures = ["x86_64"], CreatedAt = Oldest, UpdatedAt = Middle },
    ];
    ...
    public void ApplySort_BreaksTiesById()
    {
        ...
        {
            new() { Id = second, Name = "tied-b", SupportedArchitectures = ["x86_64"], CreatedAt = Oldest, UpdatedAt = Oldest },
            new() { Id = first, Name = "tied-a", SupportedArchitectures = ["x86_64"], CreatedAt = Oldest, UpdatedAt = Oldest },
        };
