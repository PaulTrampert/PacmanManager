...
public interface IRepositoryService
{
    ...
    /// <returns>The repository if it exists and is visible to the current actor; otherwise, null.</returns>
    /// <remarks>
    /// Repository names are unique per owner, not globally, so a name can match several visible
    /// repositories. The current actor's own repository wins; otherwise the oldest visible match
    /// is returned.
    /// </remarks>
