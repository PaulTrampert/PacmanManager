...
namespace PacmanManager.Migrations.Migrations
{
    ...
    [Migration("20260923162523_AddIndex_IX_PacmanPackages_RepositoryId_Name_Architecture")]
    partial class AddIndex_IX_PacmanPackages_RepositoryId_Name_Architecture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PacmanManager.Entities.PacmanAccessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PacmanManager.Entities.PacmanPackage", b =>
                {
                    ...
                    b.HasIndex("RepositoryId", "Name", "Architecture")
                        .IsUnique();
