...
{
    /// <inheritdoc />
    public partial class AddTable_PacmanAccessTokens : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PacmanAccessTokens",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PacmanAccessTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PacmanAccessTokens_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PacmanAccessTokens_UserId_NormalizedName",
