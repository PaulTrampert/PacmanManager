...
internal unsafe delegate void AlpmCbEvent(void* ctx, void* @event);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal unsafe delegate void AlpmCbQuestion(void* ctx, void* question);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal unsafe delegate void AlpmCbProgress(void* ctx, AlpmProgress progress, byte* pkg, int percent, nuint howmany, nuint current);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal unsafe delegate void AlpmCbDownload(void* ctx, byte* filename, AlpmDownloadEventType @event, void* data);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal unsafe delegate int AlpmCbFetch(void* ctx, byte* url, byte* localpath, int force);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal unsafe delegate void AlpmCbLog(void* ctx, AlpmLogLevel level, byte* fmt, IntPtr args);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal unsafe delegate void AlpmListFnFree(void* item);

/// <summary>
/// List item comparison callback (alpm_list_fn_cmp)
/// </summary>
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
internal unsafe delegate int AlpmListFnCmp(void* a, void* b);
